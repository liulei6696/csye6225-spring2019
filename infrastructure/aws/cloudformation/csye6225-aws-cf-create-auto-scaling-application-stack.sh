...
TagKey=domainName
TagValue=csye6225
CertificateArn1=`aws acm list-certificates --query "CertificateSummaryList[0].CertificateArn" | sed 's/\"//g'`
...
echo "certificate found: "$CertificateArn1
